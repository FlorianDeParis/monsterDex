...
export const pokedexList: PokedexListEntry[] = [
  ...
  },
  {
    ...
    pokedexVariants: [
      ...
      {
        pokedexId: 22,
        pokedexVariantName: 'Pokédex d\'Ultra-Soleil / Ultra-Lune de la région de Melemele'
      },
      {
        pokedexId: 23,
        pokedexVariantName: 'Pokédex d\'Ultra-Soleil / Ultra-Lune de la région d\'Akala'
      },
      {
        pokedexId: 24,
        pokedexVariantName: 'Pokédex d\'Ultra-Soleil / Ultra-Lune de la région d\'Ula\'ula'
      },
      {
        pokedexId: 25,
        pokedexVariantName: 'Pokédex d\'Ultra-Soleil / Ultra-Lune de la région Poni'
      },
    ]
  },
  {
    ...
    pokedexVariants: [
      ...
      {
        pokedexId: 28,
        pokedexVariantName: 'Pokédex d\'Épée / Bouclier de la région d\'Isolarmure'
      },
      {
        pokedexId: 29,
        pokedexVariantName: 'Pokédex d\'Épée / Bouclier de la région de Couronneige'
      },
    ]
  },
  {
